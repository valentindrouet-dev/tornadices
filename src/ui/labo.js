...
import { h, remplacer, pourcent, nombre, dureeLongue, telecharger } from './dom.js?v=1.60';
import { pastilleSymbole, suiteSymboles } from './icons.js?v=1.60';
import { nomSymbole } from './apparence.js?v=1.60';
import { store } from './store.js?v=1.60';
import { lancerCampagne, SCHEMA_RESULTAT } from '../core/sim.js?v=1.60';
import {
...
import { tableauCombos } from './combos.js?v=1.60';
import { barreProfils, idActif } from './profils.js?v=1.60';
import {
  construireConfig, tableLots, tableCartes, tableCartesVert,
} from './variables.js?v=1.60';
import {
  loiDuDe, loiBinomiale, courseCombinaison, courseAvecGarde, esperanceAvantPerte,
} from '../core/proba.js?v=1.60';
