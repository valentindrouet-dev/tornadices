...
import { h, remplacer, pourcent, nombre, dureeLongue, telecharger } from './dom.js?v=1.65';
...
import { lancerCampagne, SCHEMA_RESULTAT } from '../core/sim.js?v=1.65';
import {
...
import { tableauCombos } from './combos.js?v=1.65';
import { barreProfils, idActif } from './profils.js?v=1.65';
import {
  construireConfig, tableLots, tableCartes, tableCartesVert,
} from './variables.js?v=1.65';
import {
  loiDuDe, loiBinomiale, courseCombinaison, courseAvecGarde, esperanceAvantPerte,
} from '../core/proba.js?v=1.65';
