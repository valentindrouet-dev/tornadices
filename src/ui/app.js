...
import { SVG_LOGO } from './icons.js?v=1.67';
import { VERSION } from '../version.js?v=1.67';
import { vueAccueil } from './accueil.js?v=1.67';
import { vueTable, partieEnCours } from './table.js?v=1.67';
import { vueLabo } from './labo.js?v=1.67';
import { vueVariables } from './variables.js?v=1.67';
import { vueHistorique } from './historique.js?v=1.67';
import { vueVersions } from './versions.js?v=1.67';
import { vueRegles } from './regles.js?v=1.67';
import { vueResultats } from './resultats.js?v=1.67';
import { vueFiche } from './fiche.js?v=1.67';
