...
import { pastilleSymbole, suiteSymboles, emblemeEquipe } from './icons.js?v=1.61';
import { nomSymbole } from './apparence.js?v=1.61';
import { construireConfig } from './variables.js?v=1.61';
import { nomActif } from './profils.js?v=1.61';
