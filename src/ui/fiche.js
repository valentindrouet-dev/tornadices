...
import { pastilleSymbole, suiteSymboles, emblemeEquipe } from './icons.js?v=1.62';
import { nomSymbole } from './apparence.js?v=1.62';
import { construireConfig } from './variables.js?v=1.62';
import { nomActif } from './profils.js?v=1.62';
