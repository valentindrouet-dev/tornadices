...
import { eveillerSons } from './sons.js?v=1.42';
import { lancerPartie, partieEnCours } from './table.js?v=1.42';
import { construireConfig, variables } from './variables.js?v=1.42';
import {
