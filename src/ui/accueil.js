...
import { eveillerSons } from './sons.js?v=1.36';
import { lancerPartie, partieEnCours } from './table.js?v=1.36';
import { construireConfig, variables } from './variables.js?v=1.36';
import {
