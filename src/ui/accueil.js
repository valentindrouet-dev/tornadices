...
import { eveillerSons } from './sons.js?v=1.66';
import { lancerPartie, partieEnCours } from './table.js?v=1.66';
import {
...
import { reglagesCourants, enregistrerReglages } from './profils.js?v=1.66';
