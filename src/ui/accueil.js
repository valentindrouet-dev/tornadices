...
import { eveillerSons } from './sons.js?v=1.61';
import { lancerPartie, partieEnCours } from './table.js?v=1.61';
import {
...
import { pastilleSymbole, emblemeEquipe } from './icons.js?v=1.61';
import { randomSeed } from '../core/rng.js?v=1.61';
import { reglagesCourants, enregistrerReglages } from './profils.js?v=1.61';
