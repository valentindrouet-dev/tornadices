...
import { eveillerSons } from './sons.js?v=1.63';
import { lancerPartie, partieEnCours } from './table.js?v=1.63';
import {
...
import { pastilleSymbole, emblemeEquipe } from './icons.js?v=1.63';
import { randomSeed } from '../core/rng.js?v=1.63';
import { reglagesCourants, enregistrerReglages } from './profils.js?v=1.63';
