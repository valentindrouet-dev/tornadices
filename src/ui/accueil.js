...
import { eveillerSons } from './sons.js?v=1.65';
import { lancerPartie, partieEnCours } from './table.js?v=1.65';
import {
...
import { reglagesCourants, enregistrerReglages } from './profils.js?v=1.65';
