...
import { eveillerSons } from './sons.js?v=1.45';
import { lancerPartie, partieEnCours } from './table.js?v=1.45';
import { construireConfig, variables } from './variables.js?v=1.45';
import {
...
import { pastilleSymbole, emblemeEquipe } from './icons.js?v=1.45';
import { randomSeed } from '../core/rng.js?v=1.45';
import { reglagesCourants, enregistrerReglages } from './profils.js?v=1.45';
