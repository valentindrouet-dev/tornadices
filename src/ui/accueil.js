...
import { eveillerSons } from './sons.js?v=1.41';
import { lancerPartie, partieEnCours } from './table.js?v=1.41';
import { construireConfig, variables } from './variables.js?v=1.41';
import {
