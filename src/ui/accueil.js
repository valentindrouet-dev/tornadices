...
import { eveillerSons } from './sons.js?v=1.46';
import { lancerPartie, partieEnCours } from './table.js?v=1.46';
import { construireConfig, variables } from './variables.js?v=1.46';
import {
...
import { pastilleSymbole, emblemeEquipe } from './icons.js?v=1.46';
import { randomSeed } from '../core/rng.js?v=1.46';
import { reglagesCourants, enregistrerReglages } from './profils.js?v=1.46';
