...
import { ajouterHistorique } from './store.js?v=1.58';
import { enregistrerPartie } from './resultats.js?v=1.58';
import { aller } from './app.js?v=1.58';
import { jouerSon, eveillerSons, sonsActifs, reglerSons } from './sons.js?v=1.58';
