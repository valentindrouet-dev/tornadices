...
import { ajouterHistorique } from './store.js?v=1.57';
import { enregistrerPartie } from './resultats.js?v=1.57';
import { aller } from './app.js?v=1.57';
import { jouerSon, eveillerSons, sonsActifs, reglerSons } from './sons.js?v=1.57';
