...
import { h, remplacer, duree, vider } from './dom.js?v=1.56';
import {
  faceDe, suiteSymboles, emblemeEquipe,
  SVG_TORNADE_EVEILLEE, SVG_TORNADE_ENDORMIE, SVG_SYMBOLE,
} from './icons.js?v=1.56';
import { Moteur } from '../core/engine.js?v=1.56';
import {
...
import { ajouterHistorique } from './store.js?v=1.56';
import { enregistrerPartie } from './resultats.js?v=1.56';
import { aller } from './app.js?v=1.56';
import { jouerSon, eveillerSons, sonsActifs, reglerSons } from './sons.js?v=1.56';
