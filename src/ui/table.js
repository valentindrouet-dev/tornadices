...
import { h, remplacer, duree, vider } from './dom.js?v=1.23';
import {
  faceDe, suiteSymboles, SVG_TORNADE_EVEILLEE, SVG_TORNADE_ENDORMIE, SVG_SYMBOLE,
} from './icons.js?v=1.23';
import { Moteur } from '../core/engine.js?v=1.23';
import {
  COULEURS_EQUIPE, ALERTES, comboServie, exigenceVide,
} from '../core/config.js?v=1.23';
import { ajouterHistorique } from './store.js?v=1.23';
