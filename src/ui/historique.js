...
import { h, remplacer, dureeLongue, nombre, telecharger } from './dom.js?v=1.15';
import { historique, viderHistorique, historiqueCSV } from './store.js?v=1.15';
import { COULEURS_EQUIPE } from '../core/config.js?v=1.15';
