...
import { h, remplacer, dureeLongue, nombre, telecharger } from './dom.js?v=1.65';
import { historique, viderHistorique, historiqueCSV } from './store.js?v=1.65';
import { COULEURS_EQUIPE } from '../core/config.js?v=1.65';
import { aller } from './app.js?v=1.65';
import { dernierePartie } from './resultats.js?v=1.65';
