...
import { h, remplacer, dureeLongue, nombre, telecharger } from './dom.js?v=2.0';
import { historique, viderHistorique, historiqueCSV } from './store.js?v=2.0';
import { COULEURS_EQUIPE } from '../core/config.js?v=2.0';
